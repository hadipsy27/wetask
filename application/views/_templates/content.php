		...
		<div class="app-content content">
			<div class="content-wrapper">
				<div class="content-header row">
					...
					<div class="row main-menu menu-static menu-light menu-accordion menu-shadow sidebar"
							...
							<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
								...
								<li class=" nav-item"><a href="#"><i class="la la-puzzle-piece"></i><span class="menu-title"
									...
									<ul class="menu-content">
										...
										<li><a class="menu-item"
												href="../../../starter-kit/ltr/vertical-content-menu-template/layout-dark.html"
...
<div class="col-9 content" style="left: 17%; width: 100%;">
